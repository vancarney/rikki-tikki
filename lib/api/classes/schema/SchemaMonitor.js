...
SchemaMonitor = (function(_super) {
  ...
  SchemaMonitor.prototype.startPolling = function() {
    return this.__iVal != null ? this.__iVal : this.__iVal = fs.watch("" + (RikkiTikkiAPI.getOptions().schema_path), (function(_this) {
...
SchemaMonitor.getInstance = function() {
  return this.__instance != null ? this.__instance : this.__instance = new SchemaMonitor();
};
