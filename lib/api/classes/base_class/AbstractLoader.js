  ...
  AbstractLoader.prototype.load = function(callback) {
    ...
    try {
      if (this.__path.match(/\.js+$/)) {
        return typeof callback === "function" ? callback(null, this.__data = require(this.__path)) : void 0;
      } else {
      ...
      e = _error;
      return typeof callback === "function" ? callback("could not load file '" + this.__path, null) : void 0;
    }
  };
