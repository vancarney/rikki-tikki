...
CollectionManager = (function(_super) {
  ...
  CollectionManager.prototype.getCollection = function(name, callback) {
    ...
    if (((collection = this.__cache[name]) != null) && collection instanceof Collection) {
      ...
      try {
        return (_ref = (col = new Collection(name))) != null ? _ref.getCollection((function(_this) {
          return function(e, col) {
            return typeof callback === "function" ? callback(e, e != null ? null : _this.__cache[name] = col) : void 0;
          };
        })(this)) : void 0;
      } catch (_error) {
        e = _error;
