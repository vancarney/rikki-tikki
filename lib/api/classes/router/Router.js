...
Router = (function(_super) {
  ...
  function Router() {
    ...
    (this.__db = RikkiTikkiAPI.getConnection()).on('open', (function(_this) {
      return function() {
  ...
  Router.prototype.intializeRoutes = function() {
    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      operation = _ref[_i];
      collections = RikkiTikkiAPI.getEnvironment() === 'development' ? [':collection'] : RikkiTikkiAPI.getSchemaManager().listSchemas();
...
Router.getInstance = function() {
  return this.__instance != null ? this.__instance : this.__instance = new Router;
};
