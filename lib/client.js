...
(function() {
  ...
  if (!global.RikkiTikki) {
    ...
    RikkiTikki.createSchema = function(name, options) {
      ...
      if ((s = RikkiTikki.getSchema(name)) != null) {
    ...
    RikkiTikki.initialize = function(opts, callback) {
      ...
      RikkiTikki.API_URL = this.getAPIUrl();
      return (this.schemaLoader = new RikkiTikki.SchemaLoader).fetch({
  ...
  RikkiTikki.getAPIUrl = function() {
    return "" + (this.PROTOCOL.toLowerCase()) + "://" + this.HOST + (this.PORT !== 80 ? ':' + this.PORT : '') + "/" + (this.BASE_PATH.replace(/^\//, ''));
  };
  ...
  RikkiTikki.SchemaLoader = (function(_super) {
    ...
    SchemaLoader.prototype.url = function() {
      return "" + (RikkiTikki.getAPIUrl()) + "/__schema__";
    };
    ...
    SchemaLoader.prototype.fetch = function(opts) {
      ...
      return SchemaLoader.__super__.fetch.call(this, params);
    };
