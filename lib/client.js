...
(function() {
  ...
  RikkiTikki.validateRoute = function(route) {
    if (!route.match(new RegExp("^(" + (RikkiTikki.regEscape(RikkiTikki.API_URI)) + "\/)?(batch|classes|events|files|functions|login|push|requestPasswordReset|users|jobs)+"))) {
  ...
  RikkiTikki.Object = (function(_super) {
    ...
    Object.prototype.url = function() {
      var p;
      return "" + RikkiTikki.API_URI + "/classes/" + this.className + (!this.isNew() ? '/' + (this.get('objectId')) : '') + ((p = RikkiTikki.querify(this.__op)).length ? '?' + p : '');
    };
  ...
  RikkiTikki.Collection = (function(_super) {
    ...
    Collection.prototype.url = function() {
      var p;
      return encodeURI("" + RikkiTikki.API_URI + "/classes/" + this.className + (this.__method === 'read' && (p = RikkiTikki.querify(this.__params)).length ? '?' + p : ''));
    };
  ...
  RikkiTikki.Collection.or = function() {
    var queries;
