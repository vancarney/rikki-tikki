...
(function() {
  ...
  if (!global.RikkiTikki) {
    ...
    RikkiTikki.createNameSpace = function(ns) {
      return (typeof window !== 'undefined' ? window : global)[ns] = _.extend({}, RikkiTikki);
    };
    ...
    Object.prototype.setSchema = function(schema) {
      ...
      if ((virtuals = this.__schema.virtuals) != null) {
        _.each(virtuals, (function(_this) {
          return function(v, k) {
            _this[k] = RikkiTikki.Function.fromString(v);
            return console.log(_this[k]);
          };
        })(this));
      }
      ...
      if (this.__schema.paths != null) {
        return _.each(this.__schema.paths, (function(_this) {
          return function(v, k) {
            return (_this.defaults != null ? _this.defaults : _this.defaults = {})[k] = v["default"] || v.instance;
          };
        })(this));
      }
    };
