...
(function() {
  ...
  if (!global.RikkiTikki) {
    ...
    RikkiTikki.createSchema = function(name, options) {
      ...
      if ((s = RikkiTikki.__SCHEMAS__[name]) != null) {
        return RikkiTikki.__SCHEMAS__[name] = _.extend(s, options);
      } else {
        return RikkiTikki.__SCHEMAS__[name] = new RikkiTikki.Schema(options);
      }
    };
    RikkiTikki.initialize = function(app_id, rest_key) {
      RikkiTikki.APP_ID = app_id;
      return RikkiTikki.REST_KEY = rest_key;
    };
  }
  ...
  RikkiTikki.validateRoute = function(route) {
    if (!route.match(new RegExp("^(" + (RikkiTikki.regEscape(RikkiTikki.API_URI)) + "\/)+"))) {
  ...
  RikkiTikki.Function.fromString = function(string) {
    var m;
    if ((m = string.match(/^function+\s?\(([a-z-A-Z0-9_\s\,]*)\)+\s?\{(.*)\}$/)) != null) {
  ...
  RikkiTikki.SchemaItem = (function() {
    function SchemaItem(path, obj) {
      ...
      _.each((_.partial(_.without, _.keys(obj))).apply(this, allowed), (function(_this) {
        return function(v) {
          return delete obj[v];
        };
      })(this));
  ...
  RikkiTikki.Object = (function(_super) {
    ...
    Object.prototype.get = function(attr) {
      var v, value;
      if (this.__schema.virtual[attr]) {
        value = (_.isArray((v = this.__schema.virtual[attr])) ? v : [v]).reduce((function(_this) {
    ...
    Object.prototype.set = function(attr, value) {
      var v;
      if (this.__schema.virtual[attr]) {
        return (_.isArray((v = this.s__chema.virtual[attr])) ? v : [v]).reduce((function(_this) {
          return function(prev, curr, idx, arr) {
            return curr.apply(_this, value);
          };
        })(this));
      } else {
        return Object.__super__.set.call(this, attr, value);
      }
    };

    Object.prototype.url = function() {
      var p;
      return "" + RikkiTikki.API_URI + "/" + this.className + (!this.isNew() ? '/' + (this.get(this.idAttribute)) : '') + ((p = RikkiTikki.querify(this.__op)).length ? '?' + p : '');
    };
  ...
  RikkiTikki.Collection = (function(_super) {
    ...
    Collection.prototype.url = function() {
      var p;
      return encodeURI("" + RikkiTikki.API_URI + "/" + this.className + (this.__method === 'read' && (p = RikkiTikki.querify(this.__params)).length ? '?' + p : ''));
    };
    ...
    function Collection(attrs, opts) {
      ...
      this.__schema = new RikkiTikki.Schema(_.extend(RikkiTikki.__SCHEMAS__[this.className], this.schema, opts.schema || {}));
      this;
    }
  ...
  RikkiTikki.Query = (function() {
    ...
    Query.prototype.contains = function(col, val) {
      return this.set(col, '$regex', "" + (RikkiTikki.Query._quote(val)));
    };
