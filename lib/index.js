...
var APIOptions, ApiHero, Document, EventEmitter, ModuleManager, SyncInitializer, Util, _, e, fs, loadHelpers, path,
...
loadHelpers = function(callback) {
  ...
  return fs.readdir(path.join(app_root, 'helpers'), (function(_this) {
