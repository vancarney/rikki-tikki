...
var AuthConfigManager, ClientLoader, CollectionManager, CollectionMonitor, EventEmitter, Model, RikkiTikkiAPI, SchemaManager, SchemaTree, SchemaTreeManager, SyncService, path, _, _collections, _connections, _dsn, _router, _types,
...
RikkiTikkiAPI.listCollections = function() {
  return this.getCollectionManitor().getNames();
};
...
AuthConfigManager = require('./classes/auth/AuthConfigManager');
...
RikkiTikkiAPI._adapters = require('./classes/request_adapters');
