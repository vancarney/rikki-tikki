...
var AdapterManager, ClientLoader, CollectionManager, CollectionMonitor, EventEmitter, Model, RikkiTikkiAPI, SchemaManager, SchemaMonitor, SchemaTree, SchemaTreeManager, SyncService, cnf, e, fs, path, _, _collections, _connections, _router, _types,
...
RikkiTikkiAPI.createAdapter = function(name, opts) {
  return AdapterManager.getInstance().createAdapter.apply(this, arguments);
};

RikkiTikkiAPI.getAdapterByName = function(name) {
  return AdapterManager.getInstance().getAdapter.apply(this, arguments);
};
...
RikkiTikkiAPI.registerAdapter = function(name, adapterClass) {
  return AdapterManager.getInstance().registerAdapter.apply(this, arguments);
};
