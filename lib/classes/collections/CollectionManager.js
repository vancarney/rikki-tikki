...
CollectionManager = (function(_super) {
  ...
  CollectionManager.prototype.listCollections = function(dsNames, callback) {
    var cols, done, ds, name, names, _i, _len, _results;
    if (dsNames == null) {
      dsNames = null;
    }
    ...
    for (_i = 0, _len = names.length; _i < _len; _i++) {
      name = names[_i];
      if ((ds = this.__ds.getDataSource(name)).hasOwnProperty('ApiHero')) {
        _results.push(ds.ApiHero.listCollections((function(_this) {
        ...
        _results.push(process.nextTick((function(_this) {
          return function() {
