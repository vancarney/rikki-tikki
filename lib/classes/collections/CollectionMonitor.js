...
var AbstractMonitor, CollectionMonitor, DSManager, DataSourceManager, Util, async, _,
  ...
  CollectionMonitor.prototype.refresh = function(callback) {
    ...
    return async.forEachOf(dsm.getDSNames(), ((function(_this) {
      ...
      return function(e) {
        ...
        return typeof callback === "function" ? callback(_this, e == null ? [null, list] : [e]) : void 0;
      };
    })(this));
  };
