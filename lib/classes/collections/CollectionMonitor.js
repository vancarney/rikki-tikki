  ...
  CollectionMonitor.prototype.refresh = function(callback) {
    ...
    list = [];
      ...
      return function() {
        ...
        return typeof callback === "function" ? callback(_this, typeof e === "undefined" || e === null ? [null, list] : [e]) : void 0;
      };
    })(this));
    _results = [];
    for (_i = 0, _len = names.length; _i < _len; _i++) {
      ...
      if ((ds = dsm.getDataSource(dsName)) != null) {
        _results.push(ds.listCollections((function(_this) {
          return function(e, cols) {
            if (e != null) {
              return callback(e);
            }
            list = _.flatten(list.concat(_.compact(_.map(cols, function(n) {
              var name;
