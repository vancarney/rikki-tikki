...
var Collection, Document, Util, _,
...
Collection = (function(_super) {
  ...
  function Collection(_at_name, _at_ds) {
    this.name = _at_name;
    this.ds = _at_ds;
    if (!this.name) {
    ...
    this.getCollection = (function(_this) {
      return function(callback) {
        if (_this.ds.collection == null) {
          return typeof callback === "function" ? callback('Database is not connected', null) : void 0;
        }
        return _this.ds.collection(_this.name, function(e, collection) {
...
Collection.create = function(name, ds, json, opts, callback) {
  if (typeof opts === 'function') {
    callback = arguments[2];
    opts = null;
  }
  return ds.createCollection(name, json, opts, (function(_this) {
    return function(e, collection) {
      if (collection) {
        return typeof callback === "function" ? callback(null, new Collection(name, ds)) : void 0;
      } else {
        return typeof callback === "function" ? callback("unable to create collection " + name, null) : void 0;
      }
    };
  })(this));
};

Collection.build = function(name, ds, json, opts, callback) {
  if (typeof opts === 'function') {
    callback = arguments[2];
    opts = null;
  }
  return ds.buildCollection(name, json, opts, (function(_this) {
    return function(e, collection) {
      if (collection) {
        return typeof callback === "function" ? callback(null, new Collection(name, ds)) : void 0;
      } else {
