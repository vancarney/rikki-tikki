...
Collection = (function(_super) {
  ...
  Collection.prototype._sanitize = function(params) {
    return JSON.parse(Util.String.stripNull(typeof params === 'string' ? params : JSON.stringify(params)));
  };

  Collection.prototype.find = function(params, opts, callback) {
    if (!params) {
      throw 'argument `params` required';
    }
    if (typeof params !== 'object') {
      throw 'argument `params` expected type `pbject` type was #{typeof params}';
    }
    if (typeof opts === 'function') {
    ...
    return this.getCollection((function(_this) {
      return function(e, col) {
        ...
        return col.find(_this._sanitize(params), opts, callback);
      };
    })(this));
  };
