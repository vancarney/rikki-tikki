...
var APIOptions, DataSourceManager, SchemaTreeManager;
...
module.exports.init = function(ApiHero) {
  var CollectionManager, CollectionMonitor, SchemaManager, SchemaMonitor;
  if (!APIOptions.get('monitoring_enabled')) {
    return;
  }
  SchemaManager = require('../schema/SchemaManager');
  SchemaMonitor = require('../schema/SchemaMonitor');
  console.log("ApiHero.createSyncInstance: " + (ApiHero.createSyncInstance.toString()));
