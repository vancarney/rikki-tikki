...
SyncService = (function(_super) {
  ...
  function SyncService() {
      ...
      return function() {
        _.each(_schemas, function(v, k) {
          return _this.collectionManager.getCollection(v.name, function(e, col) {
            if (col == null) {
              return _this.collectionManager.createCollection(v.name, function() {
                return _this.__opCache.push(new SyncOperation(v.name, 'added'));
              });
            }
          });
        });
    ...
    SchemaMonitor.getInstance().on('init', (function(_this) {
    ...
    CollectionMonitor.getInstance().on('init', (function(_this) {
      return function(data) {
    ...
    if (!(0 <= (idx = this.getOpIndex(name, 'added')))) {
      return this.collectionManager.getCollection(name, (function(_this) {
        return function(e, col) {
          if (e != null) {
            return logger.log("collectionAdded: " + e);
          }
