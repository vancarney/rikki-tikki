...
AbstractRoute = (function(_super) {
  ...
  function AbstractRoute(callback) {
    var DSManager, dsm, _collections, _createCollection, _getDS;
    ...
    _createCollection = (function(_this) {
      return function(name, dsname, json, opts, callback) {
        var ds;
        ds = _getDS(dsname);
        return ds.buildCollection(name, json, opts, callback);
      };
    })(this);
      ...
      return function(req, res) {
        ...
        _this.handler.show = function(callback) {
          ...
          return _collections.getCollection(name, function(e, col) {
            ...
            return col.findOne({
              _id: new Fleek.getConnection().getTypes().ObjectId(req.params.id)
            }, function(e, doc) {
              if (e != null) {
                return typeof callback === "function" ? callback(e, null) : void 0;
              }
            ...
            if (col != null) {
              ...
              if (Util.Env.isDevelopment()) {
                return req.on('data', function(b) {
                  ...
                  data = JSON.parse(b.toString('utf8'));
                  if ((data != null) && ((data = _this.sanitize(data)) != null)) {
                    return _createCollection(name, null, data, null, function(e, res) {
                      console.log(res);
                      return callback != null ? callback.apply(_this, [
                        null, {
                          status: 200,
            ...
            if (col != null) {
              return req.on('data', function(b) {
                ...
                if ((id = req.params.id) != null) {
                  return col.update({
                    _id: new Fleek.getConnection().getTypes().ObjectId(id)
                  }, {
                    $set: data
                  }, function(e, num, rec) {
                    if (e != null) {
