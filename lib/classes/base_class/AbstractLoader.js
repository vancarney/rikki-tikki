...
var AbstractLoader, EventEmitter, Util, _, fs, path,
...
AbstractLoader = (function(superClass) {
  extend(AbstractLoader, superClass);

  AbstractLoader.prototype.replacer = null;

  function AbstractLoader(__path) {
    this.__path = __path;
    if ('AbstractLoader' === Util.Function.getConstructorName(this)) {
