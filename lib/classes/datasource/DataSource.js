...
DataSourceWrapper = (function(superClass) {
  extend(DataSourceWrapper, superClass);
  ...
  DataSourceWrapper.prototype.listModels = function() {
    ...
    l = _.filter(this.models, (function(_this) {
      return function(model, name) {
        var ref1;
        return (0 > BuiltIns.indexOf(name)) && (model !== void 0) && (((ref1 = model.getDataSource()) != null ? ref1.settings.name : void 0) === _this.sourceName);
      };
    })(this));
    ...
    arguments[arguments.length - 1] = (function(_this) {
      return function(e, ref) {
        ...
        return (cm = CollectionMonitor.getInstance()).refresh(function(e, list) {
          ...
          if (0 <= _.map(cm.getCollection(), 'name').indexOf(_this.name)) {
