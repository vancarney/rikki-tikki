...
DataSource = (function(_super) {
  ...
  function DataSource(name, ds) {
    ...
    if (typeof ds.buildModelFromInstance === 'function') {
      ...
      this.buildModelFromInstance = (function(_this) {
        return function(name, json, options, callback) {
          var m;
          if (!((callback != null) && typeof callback === 'function')) {
            throw 'callback is required as arguments[3]';
          }
          m = ds.buildModelFromInstance.apply(_this, _.initial(arguments));
          return callback.apply(_this, m != null ? [null, m] : ['could not build model']);
        };
      })(this);
    }
  ...
  DataSource.prototype.buildCollection = function(name, json, opts) {
    ...
    if (typeof (o = this.buildModelFromInstance.apply(this, arguments)) !== 'object') {
