  ...
  function ModuleManager(_at_app) {
    ...
    this.load((function(_this) {
      return function(e, ok) {
        ...
        return _this.emit('modules-loaded', _this.__modules);
      };
    })(this));
  }
  ...
  ModuleManager.prototype.load = function(callback) {
    ...
    return fs.exists(pkg_path, (function(_this) {
      return function(e, ok) {
        ...
        _this.__modules = _.compact(_.uniq(_.map(_.keys(pkg.dependencies), function(name) {
        ...
        done = _.after(_this.__modules.length, function() {
          return callback(null, true);
        });
        return _.each(_this.__modules, function(m) {
          var module;
          try {
            module = require("" + m);
          } catch (_error) {
