...
var AbstractLoader, Schema, SchemaTree, Util, _, fs, path,
...
SchemaTree = (function(superClass) {
  extend(SchemaTree, superClass);

  function SchemaTree() {
    return SchemaTree.__super__.constructor.apply(this, arguments);
  }

  SchemaTree.prototype.replacer = Schema.replacer;

  SchemaTree.prototype.reviver = Schema.reviver;
