...
var ClientLoader, RikkiTikkiAPI, Router, Routes, RoutingParams, _,
...
Router = (function(_super) {
  ...
  function Router() {
    ...
    new ClientLoader().load((function(_this) {
      return function(e, s) {
        if (e != null) {
          throw new Error('Could not find Rikki-Tikki-Client');
        }
        return _this.__client = s;
      };
    })(this));
