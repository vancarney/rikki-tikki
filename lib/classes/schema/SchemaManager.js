...
var APIOptions, RenderableSchema, SchemaLoader, SchemaManager, Singleton, Util, fs, path, _,
  ...
  SchemaManager.prototype.load = function() {
    ...
    if (stat != null ? stat.isDirectory() : void 0) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        _results.push((this.__schemas[n = Util.File.name(file)] = new SchemaLoader("" + this.__path + path.sep + n)).on('error', (function(_this) {
          return function(e) {
            if (e != null) {
