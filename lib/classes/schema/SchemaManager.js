...
var RikkiTikkiAPI, SchemaLoader, SchemaManager, SchemaRenderer, Util, fs, path, _,
...
SchemaManager = (function(_super) {
  ...
  function SchemaManager() {
    ...
    this.__path = "" + (RikkiTikkiAPI.getOptions().get('schema_path'));
    this.load();
  }
  ...
  SchemaManager.prototype.createSchema = function(name, data, callback) {
    ...
    return this.getSchema(name, (function(_this) {
      return function(e, schema) {
        if (e != null) {
          return (schema = _this.__schemas[name] = new SchemaLoader).create("" + name, data, callback);
        } else {
  ...
  SchemaManager.prototype.toString = function(readable) {
    ...
    _.each(_.keys(this.__schemas), (function(_this) {
      return function(key) {
        return s[key] = _this.__schemas[key].__data;
      };
    })(this));
    return JSON.stringify({
      __meta__: this.__meta,
      __schemas__: s
    }, SchemaRenderer.replacer, readable ? 2 : void 0);
  };
