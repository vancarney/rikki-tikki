...
Schema.reserved = _.object(_.map("on,db,add,set,get,init,isNew,path,__path,pathType,errors,schema,options,modelName,__template,virtual,virtualpath,collection,toObject,toJSON,toString,toSource,constructor,emit,_events,_pres,_posts".split(','), function(v) {
  return [v, 1];
}));
