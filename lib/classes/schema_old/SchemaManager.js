...
var APIOptions, RenderableSchema, SchemaLoader, SchemaManager, Singleton, Util, _, fs, path,
...
SchemaManager = (function(superClass) {
  extend(SchemaManager, superClass);
  ...
  SchemaManager.prototype.load = function() {
    var e, error, file, i, len, n, ref, results, stat;
    try {
    ...
    if (stat != null ? stat.isDirectory() : void 0) {
      ref = fs.readdirSync(this.__path);
      results = [];
      for (i = 0, len = ref.length; i < len; i++) {
        ...
        results.push((this.__schemas[n = Util.File.name(file)] = new SchemaLoader("" + this.__path + path.sep + n)).on('error', (function(_this) {
          return function(e) {
            if (e != null) {
  ...
  SchemaManager.prototype.toJSON = function(pretty) {
    return JSON.parse(this.toString(pretty));
  };

  SchemaManager.prototype.toString = function(pretty) {
    var s;
    s = {};
    ...
    return JSON.stringify({
      ...
      __schemas__: s
    }, RenderableSchema.replacer, pretty ? 2 : void 0);
  };
