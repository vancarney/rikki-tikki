...
(function() {
  var ArrayCollection, Backbone, EventEmitter, RikkiTikkiAPI, fs, mongoose, path, _,
  ...
  if (!exports.RikkiTikki) {
    RikkiTikkiAPI = exports.RikkiTikkiAPI = RikkiTikkiAPI = (function(_super) {
      ...
      function RikkiTikkiAPI(dsn) {
        ...
        if (dsn !== false) {
          this.connect(dsn != null ? dsn : (new ConfigLoader).toJSON());
        }
      }
      ...
      RikkiTikkiAPI.prototype.connect = function(dsn, opts) {
        ...
        this.__db.on('open', (function(_this) {
          return function() {
            ...
            return typeof opts.open === "function" ? opts.open() : void 0;
          };
        })(this));
        this.__db.on('close', (function(_this) {
          return function() {
            return typeof opts.close === "function" ? opts.close() : void 0;
          };
        })(this));
        this.__db.on('connect', (function(_this) {
          return function() {
            return typeof opts.connect === "function" ? opts.connect() : void 0;
          };
        })(this));
  ...
  RikkiTikkiAPI.ConnectionMonitor = (function(_super) {
    __extends(ConnectionMonitor, _super);

    function ConnectionMonitor(__db, opts) {
      var _initialized;
      this.__db = __db;
      if (opts == null) {
        opts = {
    ...
    ConnectionMonitor.prototype.refresh = function(callback) {
    ...
    ConnectionMonitor.prototype.start = function(interval) {
      if (interval == null) {
        interval = 20;
      }
    ...
    ConnectionMonitor.prototype.getNames = function() {
      return _.pluck(this.__collectionNames.__list, 'name');
    };

    ConnectionMonitor.prototype.collectionExists = function(name) {
  ...
  RikkiTikkiAPI.Router = (function(_super) {
    ...
    function Router(__parent, __collections, opts) {
      this.__parent = __parent;
    ...
    Router.prototype.intializeRoutes = function() {
      ...
      return _.each(this.__collections, function(name) {
        ...
        for (key in this.__routes) {
          ...
          path = "" + prefix + path;
          app[method](path, this.__routes[key]);
