...
(function() {
  var ArrayCollection, Backbone, EventEmitter, ObjectID, RikkiTikkiAPI, mongoose, url, _,
  ...
  RikkiTikkiAPI.ConfigLoader = (function(_super) {
    ...
    function ConfigLoader(_path) {
      ...
      if (RikkiTikkiAPI.configExists(_path)) {
        this.load(_path);
      }
    }
  ...
  RikkiTikkiAPI.configExists = function(_path) {
    return fs.existsSync((typeof path !== "undefined" && path !== null ? path.match(/\.json$/) : void 0) ? _path : RikkiTikkiAPI.getFullPath());
  };
  ...
  RikkiTikkiAPI.ExpressAdapter = (function(_super) {
    ...
    ExpressAdapter.prototype.addRoute = function(route, method, handler) {
      var _base;
      return typeof (_base = this.params.app)[method] === "function" ? _base[method](route, handler) : void 0;
    };

    ExpressAdapter.prototype.responseHandler = function(res, data) {
  ...
  RikkiTikkiAPI.RoutesAdapter = (function(_super) {
    ...
    RoutesAdapter.prototype.setApp = function(app) {
      var _base;
      return (_base = this.params).app != null ? _base.app : _base.app = app;
    };
    ...
    RoutesAdapter.prototype.responseHandler = function(res, data) {
      res.setHeader('Content-Type', 'application/json');
      res.writeHead("" + data.status, data.status !== 200 ? "" + data.content : 'ok');
      return res.end(data.status === 200 ? JSON.stringify(data.content) : "");
    };
  ...
  RikkiTikkiAPI.RoutesCreate = (function(_super) {
    __extends(RoutesCreate, _super);

    function RoutesCreate(__db, callback) {
      this.__db = __db;
  ...
  RikkiTikkiAPI.RoutesDestroy = (function(_super) {
    __extends(RoutesDestroy, _super);

    function RoutesDestroy(__db, callback) {
      this.__db = __db;
      return (function(_this) {
        return function(req, res) {
          return req.on('data', function(data) {
    ...
    return RoutesDestroy;

  })(Object);

  RikkiTikkiAPI.RoutesIndex = (function(_super) {
    __extends(RoutesIndex, _super);

    function RoutesIndex(db, callback) {
      var sanitize;
      ...
      return (function(_this) {
        return function(req, res) {
          return db.getMongoDB().collection(req.params.collection, function(e, collection) {
  ...
  RikkiTikkiAPI.RoutesUpdate = (function(_super) {
    __extends(RoutesUpdate, _super);

    function RoutesUpdate(__db, callback) {
      this.__db = __db;
      return (function(_this) {
        return function(req, res) {
          return req.on('data', function(data) {
  ...
  RikkiTikkiAPI.RoutesShow = (function(_super) {
    __extends(RoutesShow, _super);

    function RoutesShow(__db, callback) {
      this.__db = __db;
      return (function(_this) {
        return function(req, res) {
          return req.on('data', function(data) {
  ...
  RikkiTikkiAPI.Routes = (function(_super) {
    ...
    Routes.prototype.createRoute = function(method, path, operation) {
      var _base;
      return this.__adapter.addRoute(path, method, typeof (_base = RikkiTikkiAPI.Routes)[operation] === "function" ? _base[operation](this.__db, this.__adapter.responseHandler) : void 0);
    };
  ...
  RikkiTikkiAPI.Routes.show = function(__db, callback) {
    this.__db = __db;
    return new RikkiTikkiAPI.RoutesShow(this.__db, callback);
  };

  RikkiTikkiAPI.Routes.update = function(__db, callback) {
    this.__db = __db;
    return new RikkiTikkiAPI.RoutesUpdate(this.__db, callback);
  };

  RikkiTikkiAPI.Routes.create = function(__db, callback) {
    this.__db = __db;
    return new RikkiTikkiAPI.RoutesCreate(this.__db, callback);
  };

  RikkiTikkiAPI.Routes.destroy = function(__db, callback) {
    this.__db = __db;
    return new RikkiTikkiAPI.RoutesDestroy(this.__db, callback);
  };

  RikkiTikkiAPI.Routes.index = function(__db, callback) {
    this.__db = __db;
    return new RikkiTikkiAPI.RoutesIndex(this.__db, callback);
  };
  ...
  RikkiTikkiAPI.Router = (function(_super) {
    ...
    function Router(__db, __collections, __adapter) {
      this.__db = __db;
      ...
      this.__routes = new RikkiTikkiAPI.Routes(this.__db, this.__adapter);
    }
    ...
    Router.prototype.intializeRoutes = function() {
      var api_path, handler, method, obj, operation, path, prefix, verbose, _i, _len, _ref, _results;
      verbose = false;
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        operation = _ref[_i];
        if (~['name', 'prefix', 'engine', 'before'].indexOf(operation)) {
          continue;
        }
        switch (operation) {
          case 'show':
        ...
        path = "" + prefix + path;
        if ((handler = this.__routes.createRoute(method, path, operation)) != null) {
          this.__adapter.addRoute(path, method, handler);
        }
        _results.push(verbose && logger.log('debug', "" + (method.toUpperCase()) + " " + path + " -> " + operation));
      }
      return _results;
    };
