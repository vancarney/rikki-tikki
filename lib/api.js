...
(function() {
  ...
  RikkiTikkiAPI.Routes = (function(_super) {
    ...
    Routes.prototype.createRoute = function(method, path, operation) {
      var _base, _base1;
      console.log(typeof (_base = RikkiTikkiAPI.Routes)[operation] === "function" ? _base[operation](this.__adapter.responseHandler) : void 0);
      return this.__adapter.addRoute(path, method, typeof (_base1 = RikkiTikkiAPI.Routes)[operation] === "function" ? _base1[operation](this.__db, this.__adapter.responseHandler) : void 0);
    };
    ...
    return (function(_this) {
      return function(req, res) {
        return req.on('data', function(data) {
          var d;
          d = JSON.parse(data);
          return _this.__db.getMongoDB().collection('Products', function(e, collection) {
  ...
  RikkiTikkiAPI.Router = (function(_super) {
    ...
    Router.prototype.intializeRoutes = function() {
      var api_path, verbose;
      verbose = false;
      api_path = RikkiTikkiAPI.getAPIPath();
      return _.each(this.__collections, (function(_this) {
        return function(name) {
          var handler, method, obj, operation, path, prefix, _i, _len, _ref, _results;
          ...
          for (_i = 0, _len = _ref.length; _i < _len; _i++) {
            ...
            path = "" + prefix + path;
            if ((handler = _this.__routes.createRoute(method, path, operation)) != null) {
              _this.__adapter.addRoute(path, method, handler);
            }
